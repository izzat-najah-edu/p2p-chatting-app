...
public class Server extends JFrame {
    ...
    private void initComponents() {
        ...
        tcpPort.setFont(new java.awt.Font("Times New Roman", Font.PLAIN, 16));
        tcpPort.setText("8888");
        tcpPort.addActionListener(this::tcpPortActionPerformed);
        ...
        userList.setFont(new java.awt.Font("Times New Roman", Font.PLAIN, 16)); // NOI18N
        jScrollPane2.setViewportView(userList);

        status.setFont(new java.awt.Font("Times New Roman", Font.PLAIN, 16)); // NOI18N
    ...
    private void startActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            if (!tcpPort.getText().isEmpty()) {
                int portNumber = Integer.parseInt(tcpPort.getText());
